        ...
        <div className="min-h-screen bg-gray-50 flex items-center justify-center p-6">
            <div className="bg-white w-full max-w-md p-8 md:p-10 rounded-3xl shadow-xl">
                ...
                <div className="text-center mb-8">
                    ...
                    <p className="text-gray-500 text-sm mt-1">Login to access your expenses</p>
                </div>
                ...
                {!otpSent ? (
                    <form onSubmit={handleSendOtp} className="space-y-6">
                        ...
                        <button
                            type="submit"
                            disabled={loading}
                            className="w-full bg-gray-900 text-white py-4 rounded-xl font-bold text-lg shadow-lg hover:bg-black active:scale-95 transition-all flex items-center justify-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed"
                        >
                            {loading ? (
                                <>
                    ...
                    <form onSubmit={handleVerifyOtp} className="space-y-6 animate-in fade-in slide-in-from-right duration-300">
                        ...
                        <div>
                            ...
                            <input
                                ...
                                className="w-full px-4 py-3 bg-white border-2 border-gray-200 rounded-xl focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 outline-none transition-all text-center text-2xl font-bold tracking-widest"
                                placeholder="••••••"
                                maxLength={6}
                                autoFocus
                            />
